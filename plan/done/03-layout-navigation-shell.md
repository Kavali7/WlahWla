...
## Actions detaillees
1. Rédiger dans `docs/ux/layout-nav-spec.md` un wireframe textuel (schéma ASCII ou description pas-à-pas) décrivant la navigation cible : logo anime, liens marketing (Solutions, Industries, Ressources, A propos), CTA `Essai gratuit` et bouton WhatsApp, en s inspirant du rythme de waohdigital.
